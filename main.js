...
random_number = Math.floor((Math.random() * quick_draw_data_set.lenght)+ 1);
sketch = quick_draw_data_set[random_number]; 
console.log(sketch);
document.getElementById("sketch_name").innerHTML = "The sketch to be drawn is" + quick_draw_data_set[random_number];
timer_counter = 0;
timer_check = "";
draw_check = "";
answer_holder = "";
